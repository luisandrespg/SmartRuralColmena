...
#define SLEEPGPS 2 * 60 * 1000        // tiempo para envío de coordenadas GPS 2 min
...
// ************  DECLARACION DE VARIABLES Y OBTENCION DE DATOS DE SENSORES
    ...
    float humedad2 = dht2.readHumidity();                 //obtenemos humedad interior
        ...
        if (isnan(temperatura)) {
                      ...
                      if (DEBUG) {
                                  Serial.println("[DHT] Error leyendo DHT1");   //COMPROBAMOS LECTURAS SENSORES TEMPERATURA
                                }
                       return;
                       }
         ...
         if (isnan(temperatura2) || isnan(humedad2)) {
                      ...
                      if (DEBUG) {
                                  Serial.println("[DHT] Error leyendo DHT2");   //COMPROBAMOS LECTURAS SENSORES TEMPERATURA Y HUMEDAD
                                }
                       return;
                       }
